...
public class BodyPartFragment extends Fragment {
    ...
    public static final String IMG_LIST = "ImageIdList" ;
    public static final  String IMG_INDEX = "ListIndex";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // getting values from saved instance state
        if(savedInstanceState != null){
            mImageIds = savedInstanceState.getIntegerArrayList(IMG_LIST);
            mListIndex  = savedInstanceState.getInt(IMG_INDEX);
        }
    ...
    public void onSaveInstanceState(Bundle currentState){
        currentState.putIntegerArrayList(IMG_LIST,(ArrayList<Integer>) mImageIds);
        currentState.putInt(IMG_INDEX,mListIndex);
